...
export function renderCommunity(state,loggedIn){
 const h=`<div class="page-head illustrated"><div class="page-head-copy"><div class="eyebrow">COMMUNITY</div><h1>みんなの環境${helpButton('meta')}</h1><p>共有された対戦・レシピから傾向を読む。</p></div><img class="page-art" src="./assets/analysis.svg" alt="" loading="lazy"></div>`;
