...
export const HELP_SECTIONS=[
 ...
 {title:'デッキ・イベント',topics:[
  {id:'decks',title:'デッキとレシピ',short:'MAIN・EXTRA・SIDEに「1《カード名》」の形式で入力します。',details:['カードは入力した順番で表示します。公式サイト発行の対応PDFからも読み取れます。','レシピがないデッキは一覧で暗く表示します。対戦は記録でき、デッキを開いてあとから新しい版を追加できます。デッキ詳細には全バージョンを通した戦績と対戦履歴も表示します。']},
 ...
 {title:'分析・データ管理',topics:[
  ...
  {id:'results',title:'勝率と集計の見方',short:'MATCH、GAME、SINGLEを別々に表示します。',details:['MATCH勝率はMATCH形式の対戦数、GAME勝率は記録された各GAME数を分母にします。SINGLEはMATCHに含めず、GAMEには含めます。','月別推移はMATCHとSINGLEを別々に集計し、選択中の期間・店舗・イベントなどの絞り込みを反映します。5 MATCH未満の項目には母数が少ないことを示す表示が付きます。']},
